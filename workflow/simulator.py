    ...
    def create_connections(self):
        ...
        for i in range(0, len(self.layers_accum)-3):
            ...
            for j in range(i, len(self.layers_accum)-2):
                ...
                possible_connections = [[x, y] for x in possible_sources for y in possible_targets if x<y and y not in self.edges['source'][x]]
                new_connections = sample(possible_connections, floor(len(possible_connections) * self.dependency_distribution[i][z]))
